            ...
            <div class="input-form col-md-12 mx-auto">
                ...
                <form class="validation-form" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" name="registerEmail" id="registerEmail"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="registerPassword2" placeholder="비밀번호 확인"
                               required>
                        <div class="invalid-feedback">
                            비밀번호를 입력해주세요.
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="name" class="form-control" name="registerName" id="registerName" placeholder="홍길동"
                               required>
                        <div class="invalid-feedback">
                            이름을 입력해주세요.
                        </div>
