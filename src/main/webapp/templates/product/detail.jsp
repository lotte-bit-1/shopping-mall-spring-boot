        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="product__details__pic__item">
                    <img src="${detail.url}" alt="" width="500px" height="500px">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div class="product__details__text">
                        ...
                        <%-- todo: price --%>
                        <div class="row justify-content-center">
                            <div id="unitPrice">${detail.price}</div>
                            <div>원</div>
                        </div>
                        <%-- todo: description --%>
                        <p>${detail.code}</p>
                        <c:if test="${detail.quantity eq 0}">
                            <h3 style="color: red; text-decoration: line-through">재고없음</h3>
                        </c:if>
                        <c:if test="${detail.quantity ne 0}">
